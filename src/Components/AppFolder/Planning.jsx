...
const PlanningApp = () => {
  ...
  const resetFilters = () => {
    setFilters({ status: 'all', priority: 'all', date: '', search: '' });
  };
...
const Sidebar = ({ filters, stats, onFilterChange, onResetFilters }) => (
  <div className="lg:col-span-1 space-y-6 mt-2 md:mt-5">
...
const MainContent = ({ tasks, chartData, chartOptions, onAddTask, onEditTask, onDeleteTask, onCompleteTask }) => (
  <div className="lg:col-span-3 space-y-6 mt-2 md:mt-5">
    <div className="bg-white rounded-xl shadow">
      <div className="p-5 border-b border-gray-200 flex justify-between items-center">
        ...
        <button 
  className="bg-gradient-to-r from-[#00A3E1] to-[#00AEEF] hover:from-[#0099D6] hover:to-[#009FDB] text-white py-2 px-4 rounded-lg flex items-center gap-2 transition"
  onClick={onAddTask}
>
  <i className="fas fa-plus"></i> Add New Task
</button>
